...
const Hero = () => {
  return (
    <div className="pb-20 pt-20 custom_cursor">
      <div>
    ...
    <div className="flex justify-center relative my-25 h-[100vh] z-10">
      <div className="max-w-[89w] lg:max-w-[60vw] flex flex-col items-center justify-center">

...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("dylanhoshujie@gmail.com")
    setCopied(true)
  }
  const downloadResume = () => {
    ...
    link.href = url;
    link.download = 'DylanHoShuJie_Resume.pdf';
    link.click();
  }
  return (
    <div
    ...
    <div className={`${id === 6 && `flex justify-center`} h-full`}>
        ...
        <div className={cn(
          titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-f-40 flex flex-col px-5 p-5 lg:p-10'
          )}>
